...
Usage: python3 invoke-demo-profile2.py <tenant-id>

This script is called by cron to test inference profiles periodically.
Creates profiles if they don't exist.
Specifically designed for Nova models (tenant-c-demo, tenant-d-demo).
"""
    ...
    try:
        ...
        response = client.create_inference_profile(
            ...
            tags=[
                ...
                {'key': 'Environment', 'value': tenant_id},
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Usage: python3 invoke-demo-profile2.py <tenant-id>")
        print("Example: python3 invoke-demo-profile2.py tenant-c-demo")
        sys.exit(1)

    tenant_id = sys.argv[1]
    log(f"🎯 Starting Bedrock Nova profile test for tenant: {tenant_id}")
    log("=" * 60)
